...
export default function AdminLayout({
  ...
  const navItems = useMemo<NavItem[]>(() => {
    const rawItems: NavItem[] = [
      ...
      { label: "Profesionales", path: "/profesionales", icon: <PsychologyAltOutlined />, roles: ["clinic_admin"] },
      { label: "Tutores", path: "/tutores", icon: <PersonOutlineOutlined />, roles: ["clinic_admin", "profesional"] },
      { label: "Pacientes", path: "/pacientes", icon: <Groups2Outlined />, roles: ["clinic_admin", "profesional"] },
      { label: "Suscripción", path: "/suscripcion", icon: <ReceiptLongOutlined />, roles: ["clinic_admin"] },
      { label: "Suscripciones", path: "/suscripciones/admin", icon: <ReceiptLongOutlined />, roles: ["super_admin"] },
